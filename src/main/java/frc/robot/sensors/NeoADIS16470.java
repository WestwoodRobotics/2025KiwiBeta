...
public class NeoADIS16470 implements AutoCloseable, NTSendable {
  ...
  private static class AcquireTask implements Runnable {
    private NeoADIS16470 imu;

    public AcquireTask(NeoADIS16470 imu) {
      this.imu = imu;
    }
   ...
   */
  public NeoADIS16470(SPI.Port port, CalibrationTime cal_time) {
