...
public class NeoSparkMax extends SparkMax {
    ...
    private SparkMaxConfig currentActiveConfig;
    private SparkMaxConfig currentWorkingConfig;
    ...
    public SparkMaxConfig getCurrentActiveConfig() {
        return currentActiveConfig;
    }

    public SparkMaxConfig getCurrentWorkingConfig() {
